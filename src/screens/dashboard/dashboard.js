  ...
  return (
    <>
          ...
          {farms.length > 0 &&
            farms.map(farm => (
              <TouchableOpacity
                key={farm?.id}
                onPress={() => {
                  navigation.navigate('dashboard2', {farm});
                }}
                style={[styles.btn]}>
                <View
                  style={{
                  ...
                  <View style={{flexDirection: 'row'}}>
                    <Image
                      ...
                      source={{uri: `${IMAGE_BASE_URL}/${farm?.image}`}}
                    />
            ...
            {farmEdit ? (
              ...
              <>
                <View style={{width: '60%'}}>
                  <TouchableOpacity
                    onPress={() => {
                      setDeleteModal({modal: true, farm: farm, crop: null});
                      setFarmModal(false);
                    }}
                    style={{
                      top: 80,
      ...
      <ConfirmationModal
        ...
        onYes={handleYes}
        onNo={() => {
          setDeleteModal({farm: null, crop: null});
          setFarmModal(true);
        }}
      ...
      <View style={styles.confirmationModalContainer}>
        <View style={styles.confirmationModalContent}>
          <Text
            ...
            {farm && crop
              ? `Are you sure to delete ${crop?.crop?.name} from ${farm?.farmName}?`
              : `Are you sure to delete ${farm?.farmName}?`}
          </Text>
