...
const LoginScreen = () => {
  ...
  return (
    <ImageBackground
      source={require('../../../assets/images/image119.png')}
            ...
            {({
              ...
              <>
                ...
                <TouchableOpacity
                  ...
                  <Text
                    style={{fontWeight: '700', fontSize: 18, color: '#000'}}>
                    Log In
                  </Text>
                </TouchableOpacity>
              </>
          ...
          <View style={styles.socialRow}>
            <TouchableOpacity style={styles.socialContainer}>
              ...
              <Svg
                ...
                <Path
                  d="M25.3031 13.366C25.3031 12.3633 25.2185 11.6316 25.0355 10.8728H13.1343V15.3985H20.12C19.9792 16.5232 19.2187 18.2169 17.5285 19.3551L17.5048 19.5066L21.2678 22.3111L21.5285 22.3361C23.9228 20.2088 25.3031 17.0787 25.3031 13.366Z"
                  fill="#4285F4"
                />
                <Path
                  d="M13.1343 25.2901C16.5568 25.2901 19.4299 24.206 21.5286 22.3362L17.5286 19.3551C16.4582 20.0733 15.0216 20.5746 13.1343 20.5746C9.7823 20.5746 6.9373 18.4473 5.92313 15.507L5.77448 15.5191L1.86172 18.4324L1.81055 18.5692C3.895 22.5529 8.17663 25.2901 13.1343 25.2901Z"
                  fill="#069DF0"
                />
                <Path
                  d="M5.92314 15.507C5.65555 14.7482 5.50068 13.9352 5.50068 13.0951C5.50068 12.255 5.65555 11.442 5.90906 10.6832L5.90198 10.5216L1.94018 7.56152L1.81055 7.62084C0.951451 9.27397 0.458496 11.1304 0.458496 13.0951C0.458496 15.0599 0.951451 16.9162 1.81055 18.5693L5.92314 15.507Z"
                  fill="#FBBC05"
                />
                <Path
                  d="M13.1343 5.61541C15.5145 5.61541 17.1201 6.60456 18.0356 7.43117L21.613 4.07074C19.416 2.10598 16.5568 0.900024 13.1343 0.900024C8.17663 0.900024 3.895 3.63711 1.81055 7.6208L5.90906 10.6832C6.9373 7.7428 9.7823 5.61541 13.1343 5.61541Z"
                  fill="#EB4335"
                />
              </Svg>
