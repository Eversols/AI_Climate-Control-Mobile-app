    ...
    <ImageBackground
      ...
      <ScrollView>
        ...
        <View style={{ marginTop: 0 }}>
          <AIDropDown btnTitle={"Choose Pest"}
            options={pestOptions}
          ...
          <TouchableOpacity onPress={() => {
            ...
            <Text style={{ fontWeight: "700", fontSize: 18, color: "#FFF" }}>+ Add more information </Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity onPress={() => {
            ...
            <Text style={{ fontWeight: "700", fontSize: 18, color: "#000" }}>Save To Dashboard</Text>
          </TouchableOpacity>
