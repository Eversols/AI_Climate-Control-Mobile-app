...
const PestScreen5 = ({ navigation, route }) => {
    ...
    <ImageBackground
      ...
      <ScrollView>
        ...
        <View style={{ alignItems: "center", marginVertical: 20, }}>
          <Text style={{ fontWeight: "700", fontSize: 20, color: "#000", textAlign: "center", width: '40%' }}>Add more information</Text>
        </View>
        <View style={{ marginTop: 0 }}>
          <View style={styles.topContainer}>
            <CustomComponent style={{ borderRadius: 10,  }}>
              <>
                <Text style={styles.modalTitle}>Insect observations: </Text>
                <TextInput
                  style={styles.textInput}

                  onChangeText={text => setInsect(text)}
                  value={insect}
                />
              </>
            </CustomComponent>
          ...
          <View style={styles.topContainer}>
            <CustomComponent style={{ borderRadius: 10,  }}>
              <>
                <Text style={styles.modalTitle}>Pesticide usage: </Text>
                <TextInput
                  style={styles.textInput}
          ...
          <TouchableOpacity onPress={() => {
            navigation.navigate("pestScreen4")
          }} style={[styles.btn, { width: "70%", }]}>
            <Text style={{ fontWeight: "700", fontSize: 18, color: "#000" }}>Save</Text>
          </TouchableOpacity>
