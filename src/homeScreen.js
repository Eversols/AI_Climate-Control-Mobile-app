...
const HomeScreen = () => {
    ...
    const farmIcons = [
      (
        <>
          ...
          {innerPolygonButtonPressed != true &&
            < TouchableOpacity
              ...
              {isPolygonButtonPressed ? (
                <View
                  style={{
                    ...
                    borderRadius: 30,
                    borderColor: '#79B66E',
                    backgroundColor: "#79B66E" // Set border color to green when pressed
                  }}
                  key={0}
                >
          ...
          {
            innerPolygonButtonPressed && <TouchableOpacity
              onPress={handleAddPolygonPress}
            >
              ...
              {innerPolygonButtonPressed ? (
                <View
                  style={{
                    ...
                    borderColor: '#79B66E', // Set border color to green when pressed
  ...
  return (
    <View style={styles.container}>
      ...
      {!innerPolygonButtonPressed && !screenState.isAddPolygonMode && farmStep === 0 && (
...
const styles = StyleSheet.create({
  ...
  arrowContainer: {
    ...
    top: '50%',
    right: -20,
    transform: [{ translateY: -10 }], // Adjust this value to align the arrow with the center
  },
  arrow: {
    width: 0,
    height: 0,
